...
import LineComponent from '../Home/Line/LineComponent'
            ...
            <div className="container-footer">
                <div className="footer">
                    ...
                    <div className="footer-contact">
                        ...
                        <ul >
                            <li>
                                <p>Address: ĐH Văn Lang</p>
                            </li>
                            <li>
                                <p>Phone: 0901328277</p>
                            </li>
                            <li>
                ...
                <div className="copyright">
                    <div>
                        <p>copyright by cuong</p>
                    </div>
                    <div className="social">
                        <ul>
                            <li>
                                <a href="https://www.tiktok.com/@gundambk?_t=8eGFNQIltR4&_r=1">
                            ...
                            <li>
                                <a href="https://www.facebook.com/profile.php?id=100095002908339&mibextid=2JQ9oc">
